            ...
            <section className="footer__links links">
                <div className="footer__container links">
                    <div className="links__contacts">
                        <div className="col">
                            <a href="teste" className="contact-icon">
                    ...
                    <div className="links__separator">
                        <ul className="links__companies company-links">
                            <li className="company-links">
                                ...
                                <ul>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">
                                            Midway Financeira
                                        </a>
                                    </li>
                                    <li className="company-links__item">
                            ...
                            <li className="company-links">
                                ...
                                <ul>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">A Empresa</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Portal de Fornecedores</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">
                                    ...
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Trabalhe Conosco</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">
                                    ...
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste"> Mapa do Site </a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste"> Guide Shop </a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">
                            ...
                            <li className="company-links">
                                ...
                                <ul>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Na prática</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Entre Costuras</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">
                                    ...
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Ações Covid-19</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Free Free</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="company-links">
                                ...
                                <ul>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Atendimento</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Perguntas Frequentes</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Trocas e Devoluções</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Portal da Privacidade</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Política de Privacidade</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Termos e Condições de Uso</a>
                                    </li>
                                    <li className="company-links__item">
                                        <a className="company-links__text" href="teste">Regras e Resultados de Sorteios</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
